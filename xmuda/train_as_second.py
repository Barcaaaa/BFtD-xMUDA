...
def parse_args():
    ...
    parser.add_argument(
        '--cfg',
        dest='config_file',
        default='/data/xmw/CDKD0329/configs/a2d2_semantic_kitti/xmuda_pl.yaml',
        metavar='FILE',
...
def train(cfg, output_dir='', run_name=''):
    ...
    start_iteration = checkpoint_data_fusion.get('iteration', 0)
    ...
    # add metrics
    train_metric_logger = init_metric_logger([train_metric_fusion])
    val_metric_logger = MetricLogger(delimiter='  ')

    def setup_train():
        # set training mode
        # Fix 2D and 3D model, only training Fusion model with pseudo labels
        model_2d.eval()
        model_3d.eval()
        model_fusion.train()
