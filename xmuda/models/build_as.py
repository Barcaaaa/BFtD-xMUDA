from xmuda.models.xmuda_arch import Net2DSeg, Net3DSeg, MFFM, MFFM_v1
...
def build_model_fusion(cfg):
    model = MFFM_v1(cfg.MODEL_3D.NUM_CLASSES)
    train_metric_fusion = SegIoU(cfg.MODEL_3D.NUM_CLASSES, name='seg_iou_fusion')
    return model, train_metric_fusion
