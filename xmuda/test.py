...
from xmuda.models.build_dn_dep import build_model_2d, build_model_3d, build_model_fusion
...
from xmuda.data.utils.validate_vis import viz
...
def test(cfg, args, output_dir=''):
    ...
    if args.viz:  # generate pseudo labels and visualize results
        viz(cfg, model_2d, model_3d, test_dataloader, test_metric_logger,
            pselab_path=pselab_path, output_dir=output_dir)
    else:
        validate(cfg, model_2d, model_3d, test_dataloader, test_metric_logger,
